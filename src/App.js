...
const gasURL =
  "https://api.etherscan.io/api?module=gastracker&action=gasoracle&apikey=YK9XI24QV8JBJ7P5NX26W7C2HAIDSGNQ3K";
  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <Link href={"https://etherscan.io/gastracker"}>
          <h5>
            ETH Gas Prices Safe: {gasPriceA} Avg: {gasPriceB} Fast: {gasPriceC}
          </h5>{" "}
        </Link>
